...
- Used for: homepage hero (`HeroExperience.tsx` — particles + tilting "liquid glass" `ScentObject`) and the perfume detail page bottle (`PerfumeBottle3D.tsx` — `MeshTransmissionMaterial` bottle + `ParticleField`).
